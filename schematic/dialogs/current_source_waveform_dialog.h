...
#ifndef CURRENTSOURCE_WAVEFORM_DIALOG_H
#define CURRENTSOURCE_WAVEFORM_DIALOG_H
...
class CurrentSourceWaveformDialog : public QDialog {
    Q_OBJECT

public:
    CurrentSourceWaveformDialog(CurrentSourceItem* item, QUndoStack* undoStack = nullptr, QGraphicsScene* scene = nullptr, const QString& projectDir = QString(), QWidget* parent = nullptr);
