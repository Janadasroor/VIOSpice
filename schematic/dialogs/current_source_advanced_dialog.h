...
#ifndef CURRENTSOURCE_ADVANCED_DIALOG_H
#define CURRENTSOURCE_ADVANCED_DIALOG_H
...
class CurrentSourceAdvancedDialog : public QDialog {
    Q_OBJECT

public:
    CurrentSourceAdvancedDialog(CurrentSourceItem* item, QUndoStack* undoStack = nullptr, QGraphicsScene* scene = nullptr, const QString& projectDir = QString(), QWidget* parent = nullptr);
