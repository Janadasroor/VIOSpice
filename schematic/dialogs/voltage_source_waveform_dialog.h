...
#ifndef VOLTAGE_SOURCE_WAVEFORM_DIALOG_H
#define VOLTAGE_SOURCE_WAVEFORM_DIALOG_H
...
class VoltageSourceWaveformDialog : public QDialog {
    Q_OBJECT

public:
    VoltageSourceWaveformDialog(VoltageSourceItem* item, QUndoStack* undoStack = nullptr, QGraphicsScene* scene = nullptr, const QString& projectDir = QString(), QWidget* parent = nullptr);
...
#endif // VOLTAGE_SOURCE_WAVEFORM_DIALOG_H
