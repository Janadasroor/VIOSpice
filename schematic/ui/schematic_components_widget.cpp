...
void SchematicComponentsWidget::populate() {
    ...
    QList<StdTool> builtInTools = {
        ...
        {"ATmega328P", "Co-Simulation"},
        {"ATmega2560", "Co-Simulation"},
        {"ATmega32U4", "Co-Simulation"},
        {"ATmega4809", "Co-Simulation"},
        {"ATtiny85", "Co-Simulation"},
        {"ATmega128", "Co-Simulation"},
        {"ATmega168", "Co-Simulation"},
