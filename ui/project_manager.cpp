...
"        padding:4px; border-radius:4px; }"
        ...
        "  color:%3; font-size:13px; show-decoration-selected: 0; selection-background-color: transparent;"
        "}"
        "QTreeWidget#ProjectTree::item {"
        "  padding:6px 8px; border-radius:4px; margin:1px 10px 1px 0px;"
        "}"
        "QTreeWidget#ProjectTree::item:hover:!selected { background:%9; }"
        ...
        "}"
        "QTreeWidget#ProjectTree::branch { background-color: transparent; }"
