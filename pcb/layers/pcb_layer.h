...
public:
    ...
    // Standard layer IDs
    static constexpr int TopCopper = 0;
    static constexpr int BottomCopper = 1;
    static constexpr int TopSilkscreen = 10;
    static constexpr int BottomSilkscreen = 11;
    static constexpr int TopSoldermask = 20;
    static constexpr int BottomSoldermask = 21;
    static constexpr int TopPaste = 30;
    static constexpr int BottomPaste = 31;
    static constexpr int TopAdhesive = 35;
    static constexpr int BottomAdhesive = 36;
    static constexpr int TopCourtyard = 40;
    static constexpr int BottomCourtyard = 41;
    static constexpr int TopFabrication = 45;
    static constexpr int BottomFabrication = 46;
    static constexpr int EdgeCuts = 50;
    static constexpr int UserDrawings = 51;
    static constexpr int UserComments = 52;
    static constexpr int UserEco1 = 53;
    static constexpr int UserEco2 = 54;
